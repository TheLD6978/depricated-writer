...
//         const tooltip = getTooltipElement(quill);
...
//         const latexInput = getTooltipLatexFormulaInput(this);
//         latexInput.style.display = 'none';
//         const mqInput = document.createElement('span');
...
//         // getTooltipSaveButton(this).addEventListener('click', () => {
//         //     mqField.latex('');
//         // });
//     };
// }(Quill, MathQuill));
